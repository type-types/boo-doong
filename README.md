...
- 러프 프로토타입 구체화 -> Figma 디자인 작업 (모르는 거 상호 소통 필수)
- Rive 애니메이션 설계

#### 2-2. 프론트 (NO.2: 뼈대 구축)

- 러프 프로토타입 & 명세 기반 최소 작동 뼈대 개발
- 2-2a. 디자인 적용 (NO.3: 2-2 완료된 부분에 대해서 2-1 완성된 부분 반영)

#### 2-3. 백엔드(NO.4)

- ERD 설계 (백엔드 기획) 및 기획자 합의
- DB 구조 및 API 구축
- 2-3a. 연동 엔지니어(테스팅 포함) 단계 진행 (NO.5: 프론트-백 연동)

#### 3. 운영/배포/QA/피드백

- 운영/배포 (NO.6: DevOps/Infra, MVP 배포) -> 이론상 2-2가 끝나고 바로 배포 가능
